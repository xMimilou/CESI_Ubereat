...
router.get("/list/restaurateur", async(req, res) => {
    try{
        const token = req.header('auth-token');
...
router.get("/list/livreur", async(req, res) => {
    try{
        const token = req.header('auth-token');
...
router.get("/total/restaurateur", async (req, res) => {
    try{
        const token = req.header('auth-token');
...
router.get("/total/livreur", async (req, res) => {
    try{
        const token = req.header('auth-token');
...
router.get("/list/lastuser", async(req, res) => {
    try{
        const token = req.header('auth-token');
